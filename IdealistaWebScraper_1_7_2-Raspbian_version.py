...
"""IdealistaWebScraper_1_7_2-Raspbian_version: Absolute paths to be run in
                                               Raspbian.
"""
...
from DropboxSync_1_0 import backup
import os
import re
import requests
from time import sleep

BACKUP_PRICE_VARIATIONS_PATH = "/Apps/PythonistaFilesSync/\
IdealistaWebScraper/Idealista_Price_Variations.csv"
BACKUP_RECORD_PATH = "/Apps/PythonistaFilesSync/\
IdealistaWebScraper/Idealista_Apts_Record.csv"
BACKUP_RETIRED_APTS_PATH = "/Apps/PythonistaFilesSync/\
IdealistaWebScraper/Idealista_Retired_Apts.csv"
BACKUP_RECORDS_ACCOUNTING_PATH = "/Apps/PythonistaFilesSync/\
IdealistaWebScraper/Idealista_Records_Accounting.csv"
DISTRICTS = {
             "Eixample": [
                 "El Fort Pienc",
...
PRICE_VARIATIONS_FILE = "/home/pi/Documents/Python Projects/\
IdealistaWebScraper/Idealista_Price_Variations.csv"
RECORD_FILE = "/home/pi/Documents/Python Projects/\
IdealistaWebScraper/Idealista_Apts_Record.csv"
RECORDING_HOURS_LIST = [7, 16]
RETIRED_APTS_FILE = "/home/pi/Documents/Python Projects/\
IdealistaWebScraper/Idealista_Retired_Apts.csv"
RECORDS_ACCOUNTING_FILE = "/home/pi/Documents/Python Projects/\
IdealistaWebScraper/Idealista_Records_Accounting.csv"
...
def backup_files():
    ...
    if price_variations_list:
        backup(
          PRICE_VARIATIONS_FILE,
          BACKUP_PRICE_VARIATIONS_PATH)

    if last_records_list:
        backup(
              RETIRED_APTS_FILE,
              BACKUP_RETIRED_APTS_PATH)

    backup(
          RECORDS_ACCOUNTING_FILE,
          BACKUP_RECORDS_ACCOUNTING_PATH)
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(os.getcwd(), RECORDS_ACCOUNTING_FILE)):
        create_total_variations_file()

    last_record_datehour = ''
    while True:
        ...
        for hour in RECORDING_HOURS_LIST:
            if hour == current_hour and\
               current_datehour != last_record_datehour:
                last_records_list = []
                ...
                last_record_datehour = current_datehour
                not_previous_records = False
                ...
                print("\t\t%d • price decrements detected"
                      % decreased_price_apts)
                print("\t\t%d • price increments detected"
                      % increased_price_apts)
                print("\t%d - already registered apartments found"
                      % already_registered_apts)
                print("\t%d - removed partments detected"
                      % removed_apts)
